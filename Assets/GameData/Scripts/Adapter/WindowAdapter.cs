...
public class WindowAdapter : CrossBindingAdaptor
{
    ...
    public class Adaptor : Window, CrossBindingAdaptorType
    {
        ...
        public override void OnDisable()
        {
            ...
            {
                m_DisableMethod = m_Instance.Type.GetMethod("OnDisable", 1);
            }
        ...
        public override void OnUpdate()
        {
            ...
            {
                m_UpdateMethod = m_Instance.Type.GetMethod("OnUpdate", 1);
            }
        ...
        public override void OnClose()
        {
            ...
            {
                m_CloseMethod = m_Instance.Type.GetMethod("OnClose", 1);
            }
