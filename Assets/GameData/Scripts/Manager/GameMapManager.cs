...
public class GameMapManager : Singleton<GameMapManager>
{
    ...
    public void AsyncLoadScene(string name)
    {
        ...
        //UIManager.Instance.PopUpWnd("", true, false, name);
    }
    public void NormalLoadScene(string name)
    {
    ...
    IEnumerator LoadSceneAsync(string name)
    {
        ...
        AsyncOperation unLoadScene = SceneManager.LoadSceneAsync(name, LoadSceneMode.Single);
